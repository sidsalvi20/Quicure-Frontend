...
function Home(){
  ...
  React.useEffect(() => {
    ...
    axios.get(`https://healthcare-backend-api.herokuapp.com/api/users/${localStorage.getItem("uid")}`,{
        headers: {
    ...
    {
        axios.get(`https://healthcare-backend-api.herokuapp.com/api/doctor/all/${localStorage.getItem("uid")}`,{
            headers: {
              Authorization: "Bearer " + localStorage.getItem("token")
  ...
  const updateData = () => {
    ...
    {
    axios.put(`https://healthcare-backend-api.herokuapp.com/api/users/doctor/${localStorage.getItem("uid")}`,{
      uid: userData.uid,
      ...
      specialization : docData.specialization
          ...
          console.log('Data posted successfully');
            ...
            {
              axios.put(`https://healthcare-backend-api.herokuapp.com/api/users/${localStorage.getItem("uid")}`,{
              uid: userData.uid,
              fname:userData.fname,
              email:userData.email,
              city:userData.city,
