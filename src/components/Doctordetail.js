...
function DoctorDetail(){
    ...
    const timeSlot = ["8.00-9.00","9.00-10.00","10.00-11.00","11.00-12.00","17.00-18.00","18.00-19.00","19.00-20.00","20.00-21.00"];
       React.useEffect(() => {
        ...
        axios.get(`https://healthcare-backend-api.herokuapp.com/api/doctor/private/${params.uid}`,{
            headers: {
        ...
        changedocData(prevState => ({
          ...
          axios.get("https://healthcare-backend-api.herokuapp.com/api/doctor/appointments",{
            headers: {
                Authorization: "Bearer " + localStorage.getItem("token")
      ...
      if(((parseInt(date.substring(8)) + 1).toString()).length == 1)
        ...
        console.log(reason1);
        setDate(date1);
        axios.post("https://healthcare-backend-api.herokuapp.com/api/doctor/book/appointments",{
            d_uid:docData.uid,
        ...
        <Typography variant='body1'>{docData.fname} {docData.lname}</Typography>
         ...
         <Grid container spacing={3}>
                ...
                <Grid item xs={4}>
                <Typography variant='body1'>{docData.email}</Typography>
                </Grid>
                <Grid item xs={2}>
                </Grid>
         </Grid>
         <Grid container spacing={3}>
                ...
                <Grid item xs={4}>
                <Typography variant='body1'>{`${docData.work_street}, ${docData.work_city}, ${docData.work_state}, ${docData.work_pincode}`}</Typography>
                </Grid>
                <Grid item xs={2}>
                </Grid>
         </Grid>
         <Grid container spacing={3}>
                ...
                <Grid item xs={4}>
                <Typography variant='body1'>{docData.contactno}</Typography>
                </Grid>
                <Grid item xs={2}>
                </Grid>
         </Grid>
         ...
         <Grid container spacing={3}>
                ...
                <Grid item xs={4}>
                <Typography variant='body1'>{docData.degree}</Typography>
                </Grid>
                <Grid item xs={2}>
                </Grid>
         </Grid>
