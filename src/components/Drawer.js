...
<Grid item xs = {1}></Grid>
        ...
        <Grid item xs = {1}></Grid>
        <Grid item xs = {10}>
      <p className = "name" align = "center"  style = {{fontSize: "1.3vw", color: "#F65798" ,fontWeight:250,marginBottom: "1vh"}}><strong>{localStorage.getItem("fname")} {localStorage.getItem("lname")}</strong></p>
      <Divider
